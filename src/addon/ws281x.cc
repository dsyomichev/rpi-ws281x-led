...
Napi::Value ws281x::get_channel_array(const Napi::CallbackInfo& info)
{
    ...
    for (int i = 0; i < RPI_PWM_CHANNELS; i++) {
        ...
        Napi::PropertyDescriptor gpionum = Napi::PropertyDescriptor::Accessor<ws281x::get_channel_gpionum,
            set_channel_gpionum>(
            "gpionum", napi_enumerable, (int*)i);
        Napi::PropertyDescriptor invert = Napi::PropertyDescriptor::Accessor<ws281x::get_channel_invert,
            set_channel_invert>(
            "invert", napi_enumerable, (int*)i);
        Napi::PropertyDescriptor count = Napi::PropertyDescriptor::Accessor<ws281x::get_channel_count,
            set_channel_count>(
            "count", napi_enumerable, (int*)i);
        Napi::PropertyDescriptor strip_type = Napi::PropertyDescriptor::Accessor<ws281x::get_channel_strip_type,
            set_channel_strip_type>(
            "strip_type", napi_enumerable, (int*)i);
        Napi::PropertyDescriptor leds = Napi::PropertyDescriptor::Accessor<ws281x::get_channel_leds,
            ws281x::set_channel_leds>(
            "leds", napi_enumerable, (int*)i);
        Napi::PropertyDescriptor brightness = Napi::PropertyDescriptor::Accessor<ws281x::get_channel_brightness,
            ws281x::set_channel_brightness>(
            "brightness", napi_enumerable, (int*)i);
        Napi::PropertyDescriptor wshift = Napi::PropertyDescriptor::Accessor<ws281x::get_channel_wshift>(
            "wshift", napi_enumerable, (int*)i);
        Napi::PropertyDescriptor rshift = Napi::PropertyDescriptor::Accessor<ws281x::get_channel_rshift>(
            "rshift", napi_enumerable, (int*)i);
        Napi::PropertyDescriptor gshift = Napi::PropertyDescriptor::Accessor<ws281x::get_channel_gshift>(
            "gshift", napi_enumerable, (int*)i);
        Napi::PropertyDescriptor bshift = Napi::PropertyDescriptor::Accessor<ws281x::get_channel_bshift>(
            "bshift", napi_enumerable, (int*)i);
        Napi::PropertyDescriptor gamma = Napi::PropertyDescriptor::Accessor<ws281x::get_channel_gamma>(
...
Napi::Value ws281x::get_channel_gamma(const Napi::CallbackInfo& info)
{
    ...
    Napi::TypedArrayOf<uint32_t> table = Napi::TypedArrayOf<uint32_t>::New(info.Env(), 256);
...
{
    Napi::Function func = DefineClass(env, "ws281x",
        { StaticAccessor<&ws281x::get_render_wait_time>(
              "render_wait_time", napi_default),
            StaticAccessor<&ws281x::get_rpi_hw>("rpi_hw", napi_default),
            StaticAccessor<&ws281x::get_freq, &ws281x::set_freq>(
                "freq", napi_default),
            StaticAccessor<&ws281x::get_dmanum, &ws281x::set_dmanum>(
                "dmanum", napi_default),
            ...
            StaticMethod<&ws281x::set_custom_gamma_factor>(
